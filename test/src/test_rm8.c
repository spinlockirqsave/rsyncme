            ...
            if ((L < f_y_sz) && (f_y_sz % L == 0)) {
                ...
                if (f_y_sz <= (2 * L)) {
                    if (rec_ctx.delta_ref_n == 0) {
                        ...
                        assert_true(rec_ctx.delta_ref_n > 0 && rec_ctx.rec_by_ref == (rec_ctx.delta_ref_n * L) && rec_ctx.delta_raw_n > 0 && rec_ctx.delta_raw_n <= (2 * L / send_threshold + ((2 * L) % send_threshold ? 1 : 0)) && rec_ctx.rec_by_raw == (f_y_sz - rec_ctx.rec_by_ref));
                    }
                } else {
                    if (rec_ctx.delta_ref_n == f_y_sz / L - 2) {
                       ...
                       assert_true(rec_ctx.rec_by_ref == (f_y_sz - L) && rec_ctx.delta_raw_n > 0 && rec_ctx.delta_raw_n <= (L / send_threshold + (L % send_threshold ? 1 : 0)) && rec_ctx.rec_by_raw == L);
                    } else {
