...
typedef uint8_t rm_push_flags;  /* Bit  meaning
                                 ...
                                 * 5    IPv4 given,
                                 * 6    do not delete @y after @z has been reconstructed,
                                 * 7 */
...
enum rm_error {
    ...
    RM_ERR_FSTAT_Y = 7,
    RM_ERR_FSTAT_Z = 8,
    RM_ERR_NONOVERLAPPING_INSERT = 9,
    RM_ERR_COPY_BUFFERED = 10,
    RM_ERR_ROLLING_CHECKSUM = 11,
    RM_ERR_RECONSTRUCTION = 12,
    RM_ERR_CREATE_SESSION = 13,
    RM_ERR_DELTA_TX_THREAD_LAUNCH = 14,
    RM_ERR_DELTA_RX_THREAD_LAUNCH = 15,
    RM_ERR_DELTA_TX_THREAD = 16,
    RM_ERR_DELTA_RX_THREAD = 17,
    RM_ERR_FILE_SIZE = 18,
