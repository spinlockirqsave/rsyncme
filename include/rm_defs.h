...
enum rm_error {
    ...
    RM_ERR_FSTAT_Z = 13,
    RM_ERR_FOPEN = 14,
    RM_ERR_FOPEN_STDOUT = 15,
    RM_ERR_FOPEN_STDERR = 16,
    RM_ERR_FREOPEN = 17,
    RM_ERR_FREOPEN_STDOUT = 18,
    RM_ERR_FREOPEN_STDERR = 19,
    RM_ERR_NONOVERLAPPING_INSERT = 20,
    RM_ERR_COPY_BUFFERED = 21,
    RM_ERR_COPY_BUFFERED_2 = 22,
    RM_ERR_COPY_OFFSET = 23,
    RM_ERR_ROLLING_CHECKSUM = 24,
    RM_ERR_RECONSTRUCTION = 25,
    RM_ERR_CREATE_SESSION = 26,
    RM_ERR_DELTA_TX_THREAD_LAUNCH = 27,
    RM_ERR_DELTA_RX_THREAD_LAUNCH = 28,
    RM_ERR_DELTA_TX_THREAD = 29,
    RM_ERR_DELTA_RX_THREAD = 30,
    RM_ERR_FILE_SIZE = 31,
    RM_ERR_FILE_SIZE_REC_MISMATCH = 32,
    RM_ERR_UNLINK_Y = 33,
    RM_ERR_RENAME_TMP_Y = 34,
    RM_ERR_RENAME_TMP_Z = 35,
    RM_ERR_MEM = 36,
    RM_ERR_CHDIR = 37,
    RM_ERR_GETCWD = 38,
    RM_ERR_FEOF = 39,
