...
enum rm_error {
    ...
    RM_ERR_CONNECT_GEN_ERR = 62,
    RM_ERR_CONNECT_TIMEOUT = 63,
    RM_ERR_CONNECT_REFUSED = 64,
    RM_ERR_CONNECT_HOSTUNREACH = 65,
    RM_ERR_MSG_PT_UNKNOWN = 66,
    RM_ERR_EOF = 67,
    RM_ERR_CH_CH_TX_THREAD = 68,
    RM_ERR_CH_CH_RX_THREAD = 69,
    RM_ERR_Y_NULL = 70,
    RM_ERR_Y_Z_SYNC = 71,
    RM_ERR_BLOCK_SIZE = 72,
    RM_ERR_RESULT_F_NAME = 73,
    RM_ERR_BUSY = 74,
    RM_ERR_UNKNOWN_ERROR = 75
