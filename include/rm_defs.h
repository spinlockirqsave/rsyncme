...
enum rm_error {
    ...
    RM_ERR_ROLLING_CHECKSUM = 13,
    RM_ERR_RECONSTRUCTION = 14,
    RM_ERR_CREATE_SESSION = 15,
    RM_ERR_DELTA_TX_THREAD_LAUNCH = 16,
    RM_ERR_DELTA_RX_THREAD_LAUNCH = 17,
    RM_ERR_DELTA_TX_THREAD = 18,
    RM_ERR_DELTA_RX_THREAD = 19,
    RM_ERR_FILE_SIZE = 20,
    RM_ERR_FILE_SIZE_REC_MISMATCH = 21,
    RM_ERR_UNLINK_Y = 22,
    RM_ERR_RENAME_TMP_Y = 23,
    RM_ERR_RENAME_TMP_Z = 24,
    RM_ERR_MEM = 25,
    RM_ERR_CHDIR = 26,
    RM_ERR_GETCWD = 27,
    RM_ERR_FEOF = 28,
    RM_ERR_FERROR = 29,
    RM_ERR_TOO_MUCH_REQUESTED = 30,
    RM_ERR_FSEEK = 31
};
