...
enum rm_error {
    ...
    RM_ERR_FSTAT_Y = 9,
    RM_ERR_FSTAT_Z = 10,
    RM_ERR_NONOVERLAPPING_INSERT = 11,
    RM_ERR_COPY_BUFFERED = 12,
    RM_ERR_COPY_BUFFERED_2 = 13,
    RM_ERR_COPY_OFFSET = 14,
    RM_ERR_ROLLING_CHECKSUM = 15,
    RM_ERR_RECONSTRUCTION = 16,
    RM_ERR_CREATE_SESSION = 17,
    RM_ERR_DELTA_TX_THREAD_LAUNCH = 18,
    RM_ERR_DELTA_RX_THREAD_LAUNCH = 19,
    RM_ERR_DELTA_TX_THREAD = 20,
    RM_ERR_DELTA_RX_THREAD = 21,
    RM_ERR_FILE_SIZE = 22,
    RM_ERR_FILE_SIZE_REC_MISMATCH = 23,
    RM_ERR_UNLINK_Y = 24,
    RM_ERR_RENAME_TMP_Y = 25,
    RM_ERR_RENAME_TMP_Z = 26,
    RM_ERR_MEM = 27,
    RM_ERR_CHDIR = 28,
    RM_ERR_GETCWD = 29,
    RM_ERR_FEOF = 30,
    RM_ERR_FERROR = 31,
    RM_ERR_TOO_MUCH_REQUESTED = 32,
    RM_ERR_FSEEK = 33,
    RM_ERR_RX = 34,
    RM_ERR_TX = 35,
    RM_ERR_TX_RAW = 36,
    RM_ERR_TX_ZERO_DIFF = 37,
    RM_ERR_TX_TAIL = 38,
    RM_ERR_TX_REF = 39
};
