...
#define RM_SERVER_LISTENQ		1           /* server's awaiting conections max, note: it is just a hint to the kernel */
#define RM_TCP_MSG_MAX_LEN		256         /* maximum length of TCP control message */
#define RM_IP_AUTH              "192.168.1.60" /* authorized IP, requests from which will be processed */
